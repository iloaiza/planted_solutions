"""
do optimization of symmetry shifted AGP solvable Hamiltonian given electronic Hamiltonian

CLA: python main_agpsym_optimize.py (moltag)
"""

import numpy as np

from utils_sym_optimize import (
    load_electronic_hamiltonian_combined_tensor,
    evaluate_cost_function,
    obtain_symshift_AGP_hamiltonian_fragment,
    save_optimized_parameters
)

from utils_symshifts import (
    obtain_symshift_AGP_hamiltonian_tensor_rotated
)
...
if __name__ == '__main__':
    ...
    op_result = obtain_symshift_AGP_hamiltonian_fragment(target)
