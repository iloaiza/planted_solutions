"""
Compute the Greedy QWC fragments FCI variances. Contants are removed before grouping. 
"""
import sys
sys.path.append("../")
import pickle 
...
h_bk = h_bk - h_bk.constant; h_bk.compress() 

psi = sl.load_ground_state(mol, 'BK')
n_qubits = count_qubits(h_bk)

### Start computing variances 
groups = get_greedy_grouping(h_bk, commutativity='qwc')
